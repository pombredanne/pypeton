An application to bootstrap Django projects
===========================================

Pypeton install a script which allows the creation of a Django project that
follows the standard layout used at [RED Interactive Agency](http://ff0000.com).

[Django documentation](https://docs.djangoproject.com/en/dev/intro/tutorial01/#creating-a-project)
explains that Django projects can be created by running `django-admin.py startproject project_name`.
This would generate a project with this file structure:
...
At RED we prefer the following directory structure:
